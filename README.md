...
Audio review uses Qwen3.5-Omni Plus through AIMLAPI, records full/selected coverage and
checks digital silence locally; fit measures actual duration/format before
